  ...
  <div className="lg:hidden fixed inset-0 z-30 bg-black/40 backdrop-blur-md px-5 py-12 animate-fadeIn">
    ...
    <div className="mt-5 bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-lg space-y-4">
      ...
      <div>
            ...
            <nav className="w-full bg-white/30 backdrop-blur-md sticky top-0 z-10 shadow-sm">
                <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
                    ...
                    <div className="hidden lg:flex items-center gap-8 capitalize text-gray-700">
                        ...
                        <Link className="hover:text-green-600 transition" href="/shop">Shop</Link>
                        <Link className="hover:text-green-600 transition" href="/admin">Admin</Link>
                        <Link className="hover:text-green-600 transition" href="/contact">Contact</Link>
                        ...
                        {/* Login */}
                        <button className="px-6 py-2 bg-purple-600 hover:bg-purple-700 transition text-white rounded-full">
                            Login
                        </button>
                    </div>
        ...
        `}
                >
                    <div className="p-6 mt-16 flex flex-col gap-6 bg-white backdrop-blur-lg text-black">
